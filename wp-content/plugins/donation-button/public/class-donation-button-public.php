...
class Donation_Button_Public {
    ...
    public function create_dropdown_option_donation_button($atts) {
        ...
        $result = "";
        $donation_lable_name = $this->Donation_Get_Lable_name($atts['lable_name']);
        $loop_count = 0;
    ...
    public function donation_create_dropdown_option_button_option_code($atts, $lable_name) {
        ...
        $result = "";
        $donation_lable_name = $this->Donation_Get_Lable_name($lable_name['lable_name']);
        $currency_selected = get_option('donation_button_currency');
