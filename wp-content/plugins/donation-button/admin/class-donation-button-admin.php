...
class Donation_Button_Admin {
    ...
    public function enqueue_styles() {
         ...
         * defined in Paypal_Invoice_Loader as all of the hooks are defined
         * in that particular class.
         *
         * The Paypal_Invoice_Loader will then create the relationship
    ...
    public static function donation_goal_detail_manager_metabox() {
        ...
        $donation_button_start_date = ($get_donation_button_post_meta_array['donation_button_start_date'])?$get_donation_button_post_meta_array['donation_button_start_date']:date("Y-m-d");
        $donation_button_end_date = ($get_donation_button_post_meta_array['donation_button_end_date'])?$get_donation_button_post_meta_array['donation_button_end_date']:date("Y-m-d");
        ...
        if (isset($donation_button_result_array) && !empty($donation_button_result_array)) {
            ...
            $donation_button_target_amount = ($get_donation_button_post_meta_array['donation_button_target_amount'])?$get_donation_button_post_meta_array['donation_button_target_amount']:0;
