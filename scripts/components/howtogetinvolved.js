...
(function (Partisan) {
    var Components;
    (function (Components) {
        var HowToGetInvolved = (function (_super) {
            __extends(HowToGetInvolved, _super);
            function HowToGetInvolved() {
                _super.call(this);
            }
            HowToGetInvolved.prototype.render = function () {
            ...
            return HowToGetInvolved;
        }(React.Component));
        Components.HowToGetInvolved = HowToGetInvolved;
